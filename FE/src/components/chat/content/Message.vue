<template>
    <div class="sc-message">
        ...
        backgroundImage: `url(${chatImageUrl})`
            ...
            <TextMessage v-if="message.type === 'text'" :data="message" :messageColors="determineMessageColors()"
            ...
            <SystemMessage v-else-if="message.type === 'system'" :data="message"
                           :messageColors="determineMessageColors()"/>
        </div>
    </div>
</template>
...
<script>
    ...
    import FileMessage from '../file/FileMessage.vue'
    import EmojiMessage from '../emoji/EmojiMessage.vue'
