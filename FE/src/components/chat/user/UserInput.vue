<template>
    <div>
        ...
        <div v-if="file" class='file-container'
            ...
            <span class='icon-file-message'><img src="../../../assets/chat_file/file.svg" alt='genericFileIcon'
                                                 height="15"/></span>
            {{file.name}}
            <span class='delete-file-message' @click="cancelFile()"><img src="../../../assets/chat_file/close.svg"
...
<script>
    import EmojiIcon from '../emoji/EmojiIcon.vue'
    import FileIcons from '../file/FileIcons.vue'
    import SendIcon from '../content/SendIcon.vue'
    import Suggestions from '../content/Suggestions.vue'
